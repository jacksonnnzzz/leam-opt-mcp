...
SHARED_RUNNER = VALIDATION_ROOT / "wifi_patch_5250" / "run_reference.py"
DEFAULT_ARGUMENTS = [
    "--project", str(CASE_DIR / "local_results" / "wifi_patch_5250.aedt"),
    "--s11", str(CASE_DIR / "local_results" / "reference_s11_edge_referenced_xp.csv"),
]
